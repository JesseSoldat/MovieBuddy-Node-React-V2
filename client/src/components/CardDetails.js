...
const CardDetails = ({
  ...
  return (
    <div className="card mb-3 mt-3">
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 ml-mr-auto">
            <ul className="list-group list-group-flush">
              ...
              {renderList("Production Company", production_companies)}
      ...
      <div className="card-footer">{renderBtn(parent)}</div>
    </div>
  );
};
